...
const blockedDomain = [".memay", ".memay"];
...
if (!reqmethod || !target || !time || !threads || !ratelimit || !proxyfile) {
    console.clear();
     ...
     console.error(gradient.atlas('═══███════█▀══════██████████═████═══════███▄ ═══▄████▀═════██████████═══███═══▀█▀══▀██████▀══'));
     console.error(gradient.atlas('════════════════════════════════════════════════════════════════════════▀════════════════════'));
     console.error(gradient.pastel('                          ┓┏┏┓┏┓┏┓┏┳┓┏┓┓┏┓┏┓  ┳┓┳┓┏┓┏┓  ┳┓┏┓┏┳┓┳┓┏┓┏┳┓'));
     console.error(gradient.pastel('                          ┣┫┣  ┃┃  ┃ ┣ ┃┫ ┃┃  ┃┃┃┃┃┃┗┓  ┣┫┃┃ ┃ ┃┃┣  ┃ '));
     console.error(gradient.pastel('                          ┛┗┗┛┗┛┗┛ ┻ ┗┛┛┗┛┗┛  ┻┛┻┛┗┛┗┛  ┻┛┗┛ ┻ ┛┗┗┛ ┻ '));
     console.error(gradient.rainbow('                              ╔═════════════════════════════════╗'));
     console.error(gradient.rainbow('                              ║Admin Tran Khoi ( trankhoic2cnc )║'));
     console.error(gradient.rainbow('                              ╚═════════════════════════════════╝'));
     console.error(gradient.mind('                              ╔═════════════════════════════════╗\n                              ║ METHODS: GET/POST/HEAD/OPTIONS  ║\n                              ╚═════════════════════════════════╝'));
     console.log(gradient.cristal('╔════════════════════════════════════════════════════════════════════════════════════════════╗'));
     console.log(gradient.cristal('║Usage: Method Target Time Threads Retelimit Proxy.txt --query 1 --cookie "uh=good" --delay 1║'));
     console.log(gradient.cristal('║--bfm true --referer rand --postdata "user=f&pass=%RAND%" --debug --randrate --full         ║'));
     console.log(gradient.cristal('╚════════════════════════════════════════════════════════════════════════════════════════════╝'))
     process.exit(1);
}
